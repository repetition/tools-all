package com.tools.agent.process.constant;
...
public class PropertKeys {
    ...
    public static final  String  CM_CONFIG_DB_NAME = "cm.config.db.name";
    public static final  String  CM_CONFIG_DB_USERNAME = "cm.config.db.userName";
    public static final  String  CM_CONFIG_DB_USERPASS = "cm.config.db.userPass";
    //资源分离配置
